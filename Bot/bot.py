...
class Bot:
    ...
    def do_turn(self):
        ...
        self.game.field.smell_trap(self.game.my_botid, self.game.other_botid, self.game.players, enemy=None, future_cell=None, moves=0)
        ...
        sys.stderr.write("\n")
        sys.stderr.flush()
        self.game.get_cell_given_direction(self.game.field.cell, value, self.game.players)
